...
class Posspecialproduct extends Module {
    ...
    function __construct() {
        ...
        $this->displayName = $this->l('Specials products with slider on the homepage.');
