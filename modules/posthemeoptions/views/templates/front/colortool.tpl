				...
				<div class="cl-container">
					<div class="cl-table">
						<div class="cl-tr cl-tr-style">
							<div class="cl-td-l cl-td-layout cl-td-layout1"><a href="#" id="blue" title="skin 1"><span></span>{l s='Skin 1'}</a></div>
							<div class="cl-td-r cl-td-layout cl-td-layout2"><a href="#" id="green" title="skin 2"><span></span>{l s='Skin 2'}</a></div>
						</div>
						<div class="cl-tr cl-tr-style">
							<div class="cl-td-r cl-td-layout cl-td-layout3"><a href="#" id="red" title="Skin 3"><span></span>{l s='Skin 3'}</a></div>
							<div class="cl-td-r cl-td-layout cl-td-layout4"><a href="#" id="orange" title="Skin 4"><span></span>{l s='Skin 4'}</a></div>
						</div>
						<div class="cl-tr cl-tr-style">
							<div class="cl-td-r cl-td-layout cl-td-layout5"><a href="#" id="brown" title="Skin 5"><span></span>{l s='Skin 5'}</a></div>
							<div class="cl-td-r cl-td-layout cl-td-layout6"><a href="#" id="pink" title="Skin 6"><span></span>{l s='Skin 6'}</a></div>
						</div>
					</div>
                </div>		
			</div>
...
//			$(document).ready( function(){ldelim}
				$('.control').click(function(){ldelim}
					...
					{rdelim} else {ldelim}
						...
						$('.pos-demo-wrap').animate({ldelim}left:'-224px'{rdelim}, 500);
					{rdelim}
				{rdelim});
//			{rdelim});
		</script>
	...
	//$(document).ready(function(){ldelim}
		...
		$(function(){ldelim}
			...
			fontUpdate=function(){ldelim}
				...
				$("<link />",{ldelim}href:"http://fonts.googleapis.com/css?family="+curFont,rel:"stylesheet",type:"text/css"{rdelim}).appendTo("head");
			{rdelim}
		...
		$("<link />",{ldelim}href:"http://fonts.googleapis.com/css?family="+$.cookie('font_cookie'),rel:"stylesheet",type:"text/css"{rdelim}).appendTo("head");
