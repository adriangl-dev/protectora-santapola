...
class Posmegamenu extends Module {
    ...
    public function __construct() {
        ...
        if (!Configuration::get('POSMEGAMENU'))
    ...
    public function install() {
        ...
        Configuration::updateValue($this->name . '_top_offset', 32);
    ...
    public function getStaticBlockContent($blockId = NULL, $task = NULL) {
        ...
        if (count($staticBlock) > 0) {
            ...
            $description = str_replace('/pos_petsyshop/',__PS_BASE_URI__,$description);
            $html .= $description;
        }
        if ($task == 'item') {
    ...
    public function drawCustomMenuBlock($blockId, $bc) {
        ...
        $blockHtml = str_replace('/pos_petsyshop/',__PS_BASE_URI__,$bc['description']);
        $drawPopup = $blockHtml;
        if ($drawPopup) {
...
//        $html[] = '</a>';
    ...
    public function hookCustomMenu() {
