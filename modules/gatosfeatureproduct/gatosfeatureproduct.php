...
class Gatosfeatureproduct extends Module {

    private $_html = '';
    private $_postErrors = array();

    function __construct() {
        $this->name = 'gatosfeatureproduct';
        ...
        $this->displayName = $this->l('Gatos en adopción como slider en la home.');
        $this->description = $this->l('Muestra los gatos en adopción como slider en la home.');
    }

    function install() {
        $this->_clearCache('gatosfeatureproduct.tpl');
    ...
    public function hookHeader($params) {
        $this->context->controller->addCSS(($this->_path) . 'css/gatosfeatureproduct.css', 'all');
...
//                $this->context->controller->addJS($this->_path.'js/jquery.elastislide.js');
    ...
    public function getSlideshowHtml() {
        ...
        if (!$this->isCached('gatosfeatureproduct.tpl', $this->getCacheId('gatosfeatureproduct'))) {
            $slideOptions = array(
        ...
        return $this->display(__FILE__, 'gatosfeatureproduct.tpl', $this->getCacheId('gatosfeatureproduct'));
    }
