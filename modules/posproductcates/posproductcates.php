...
class posproductcates extends Module
{
	...
	public function install()
	{
                ...
                Configuration::updateValue($this->name . '_title_slide', 'Product Category');
                ...
                Configuration::updateValue($this->name . '_width_item', 186);
	...
	public function uninstall()
	{
                ...
                Configuration::deleteByName($this->name . '_title_slide');
	...
	private function _postProcess() {
        ...
        Configuration::updateValue($this->name . '_title_slide', Tools::getValue('title_slide'));
    ...
    private function _displayForm() {
        ...
        $this->_html .='
                    ...
                    <div class="margin-form">
                            <input type = "text"  name="title_slide" value =' . (Tools::getValue('title_slide') ? Tools::getValue('title_slide') : Configuration::get($this->name . '_title_slide')) . ' ></input>
                    </div>
	...
	public function hookHeader($params)
	{
		...
		$this->context->controller->addJS($this->_path.'flexslider.js');
