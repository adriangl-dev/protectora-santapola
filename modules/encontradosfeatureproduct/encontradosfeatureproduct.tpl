<!-- Begin Encontradosfeature module-->
...
<div class="pos-feature-product row-fluid">
	...
	<a href="http://protectorasantapola.org/23-encontrados">
		<div class="pos-feature-product-title span3">
			<div class="pos-feature-product-title-inner">
				<p class="title" style="font-size: 35px;">{l s='Encontrados' mod='posfeatureproduct'}</p>
				{*VIRGY MOD 051215*}
