...
class Protefeatureproduct extends Module {

    private $_html = '';
    private $_postErrors = array();

    function __construct() {
        $this->name = 'protefeatureproduct';
        ...
        $this->displayName = $this->l('Perdidos como slider en la home.');
        $this->description = $this->l('Muestra los perdidos como slider en la home.');
    }

    function install() {
        $this->_clearCache('protefeatureproduct.tpl');
...
//                $this->context->controller->addJS($this->_path.'js/jquery.elastislide.js');
    ...
    public function getSlideshowHtml() {
        ...
        if (!$this->isCached('protefeatureproduct.tpl', $this->getCacheId('protefeatureproduct'))) {
            $slideOptions = array(
			...
			$category = new Category(16, (int) Context::getContext()->language->id);
        ...
        return $this->display(__FILE__, 'protefeatureproduct.tpl', $this->getCacheId('protefeatureproduct'));
    }
