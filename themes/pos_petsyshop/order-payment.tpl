...
{if !$opc}<h1 class="page-title">{l s='Choose your payment method'}</h1>{else}<h2 class="page-title"><span>3</span> {l s='Choose your payment method'}</h2>{/if}
...
<div id="order-detail-content" class="table_block">
	<table id="cart_summary" class="std">
		<thead>
			<tr>
				...
				<th class="cart_availability item hidden-phone">{l s='Avail.'}</th>
	...
	<div id="customer_cart_total" class="clearfix row-fluid">
		<div class="span8">
			{/if}
