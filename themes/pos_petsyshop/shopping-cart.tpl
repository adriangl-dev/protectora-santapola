...
<h1 id="cart_title" class="page-title">{l s='Shopping Cart'}</h1>
...
{if isset($lastProductAdded) AND $lastProductAdded}
	<div class="cart_last_product">
		...
		<a  class="cart_last_product_img" href="{$link->getProductLink($lastProductAdded.id_product, $lastProductAdded.link_rewrite, $lastProductAdded.category, null, null, $lastProductAdded.id_shop)|escape:'htmlall':'UTF-8'}"><img src="{$link->getImageLink($lastProductAdded.link_rewrite, $lastProductAdded.id_image, 'pos_small')}" alt="{$lastProductAdded.name|escape:'htmlall':'UTF-8'}"/></a>
...
<div id="order-detail-content" class="table_block">
	<table id="cart_summary" class="std">
		<thead>
			<tr>
				...
				<th class="cart_description item hidden-phone">{l s='Description'}</th>
				<th class="cart_ref item hidden-phone">{l s='Ref.'}</th>
	...
	<div class="clearfix row-fluid" id="customer_cart_total">
		<div id="HOOK_SHOPPING_CART" class="span8">{$HOOK_SHOPPING_CART}</div>
