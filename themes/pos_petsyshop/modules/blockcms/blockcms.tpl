...
{else}
	<!-- MODULE Block footer -->
	<div class="block_various_links span3" id="block_various_links_footer">
		<p class="title_block">{l s='Adopta' mod='blockcms'}</p>
		<ul>
		...
		{*Virgy MOD 05/04/15*}
		<li class="item"><a href="http://protectorasantapola.es/13-perros-en-adopcion" title="{l s='Perros en adopción' mod='blockcms'}">{l s='Perros en adopción' mod='blockcms'}</a></li>
		<li class="item"><a href="http://protectorasantapola.es/14-gatos-en-adopcion" title="{l s='Gatos en adopción' mod='blockcms'}">{l s='Gatos en adopción' mod='blockcms'}</a></li>
		<li class="item"><a href="#" title="{l s='Cómo adoptar' mod='blockcms'}">{l s='Cómo adoptar' mod='blockcms'}</a></li>
		{*************}
