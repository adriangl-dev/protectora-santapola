        ...
        <div class="pos-loading"></div>
            <div id="pos-slideshow-home" class="slides">
                ...
                {foreach from=$slides key=key item=slide}
                    <img style ="display:none" src="{$base_dir_ssl}img/blockslideshow/{$slide.id_pos_slideshow}.jpg"  data-transition="boxRainReverse" data-thumb="{$base_dir_ssl}img/blockslideshow/{$slide.id_pos_slideshow}.jpg"  alt="" title="#htmlcaption{$slide.id_pos_slideshow}"  />
                {/foreach}
            </div>
