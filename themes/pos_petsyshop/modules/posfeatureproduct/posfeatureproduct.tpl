<!--Begin Posfeaturedproduct modified by Virgy-->
<!--Display Casos especiales in homepage-->
...
<div class="pos-feature-product row-fluid">
	...
	<div class="pos-feature-product-title span3" style="margin-left: 0;">
		<a href="https://protectorasantapola.org/22-casos-especiales">
			<div class="pos-feature-product-title-inner">
				<p class="title">{l s='Casos especiales' mod='posfeatureproduct'}</p>
				{*VIRGY MOD 051215*}
...
<!-- End Posfeaturedproduct MOD by Virgy-->
