<?php /* Smarty version Smarty-3.1.19, created on 2019-04-20 11:41:45
         compiled from "/var/www/protectorasantapola/themes/pos_petsyshop/password.tpl" */ ?>
<?php /*%%SmartyHeaderCode:12055509495cbae9590fb004-29366213%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd4ee6f7f1c4639ffc41f25050866045f30a3cf3e' => 
    array (
      0 => '/var/www/protectorasantapola/themes/pos_petsyshop/password.tpl',
      1 => 1550000748,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '12055509495cbae9590fb004-29366213',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5cbae9591543e9_99252530',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5cbae9591543e9_99252530')) {function content_5cbae9591543e9_99252530($_smarty_tpl) {?>
...
<p class="success"><?php echo smartyTranslate(array('s'=>'Your password has been successfully reset and a confirmation has been sent to your email address:'),$_smarty_tpl);?>
 <?php if (isset($_smarty_tpl->tpl_vars['customer_email']->value)) {?><?php echo stripslashes(mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['customer_email']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8'));?>
<?php }?></p>
...
" method="post" class="std" id="form_forgotpassword">
	<fieldset>
		<p class="text">
			...
			<input type="text" id="email" name="email" value="<?php if (isset($_POST['email'])) {?><?php echo stripslashes(mb_convert_encoding(htmlspecialchars($_POST['email'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8'));?>
<?php }?>" />
		</p>
		<p class="submit">
