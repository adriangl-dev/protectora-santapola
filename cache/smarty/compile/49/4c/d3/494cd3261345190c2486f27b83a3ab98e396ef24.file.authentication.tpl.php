<?php /* Smarty version Smarty-3.1.19, created on 2020-09-10 10:25:11
         compiled from "/var/www/protectorasantapola/public_html/themes/pos_petsyshop/authentication.tpl" */ ?>
<?php /*%%SmartyHeaderCode:14105470795f59e2e77db2e9-22314466%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '494cd3261345190c2486f27b83a3ab98e396ef24' => 
    array (
      0 => '/var/www/protectorasantapola/public_html/themes/pos_petsyshop/authentication.tpl',
      1 => 1556915561,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '14105470795f59e2e77db2e9-22314466',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5f59e2e7ac5951_03948539',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f59e2e7ac5951_03948539')) {function content_5f59e2e7ac5951_03948539($_smarty_tpl) {?>
...
<?php } else { ?>
		<a href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('authentication',true), ENT_QUOTES, 'ISO-8859-1', true);?>
...
<h1 class="page-title"><?php if (!isset($_smarty_tpl->tpl_vars['email_create']->value)) {?><?php echo smartyTranslate(array('s'=>'Authentication'),$_smarty_tpl);?>
...
?>
	...
	<div class="row-fluid">
		<div class="span6">
			<form action="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('authentication',true), ENT_QUOTES, 'ISO-8859-1', true);?>
...
<?php }?>" class="account_input" /></span>
						...
						<p class="submit">
							<?php if (isset($_smarty_tpl->tpl_vars['back']->value)) {?><input type="hidden" class="hidden" name="back" value="<?php echo htmlentities($_smarty_tpl->tpl_vars['back']->value, ENT_QUOTES, 'UTF-8', true);?>
" /><?php }?>
...
<?php }?>" class="account_input" /></span>
				...
				<p class="lost_password"><a href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('password'), ENT_QUOTES, 'ISO-8859-1', true);?>
...
" />
	...
	<form action="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('authentication',true,null,"back=".((string)$_smarty_tpl->tpl_vars['back']->value)), ENT_QUOTES, 'ISO-8859-1', true);?>
