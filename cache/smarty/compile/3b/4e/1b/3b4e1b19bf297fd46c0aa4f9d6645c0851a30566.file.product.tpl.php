<?php /* Smarty version Smarty-3.1.19, created on 2020-09-10 17:38:19
         compiled from "/var/www/protectorasantapola/public_html/themes/pos_petsyshop/product.tpl" */ ?>
<?php /*%%SmartyHeaderCode:19137688405f5a486be5f323-88302427%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3b4e1b19bf297fd46c0aa4f9d6645c0851a30566' => 
    array (
      0 => '/var/www/protectorasantapola/public_html/themes/pos_petsyshop/product.tpl',
      1 => 1556915561,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '19137688405f5a486be5f323-88302427',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5f5a486c440114_78743469',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f5a486c440114_78743469')) {function content_5f5a486c440114_78743469($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/var/www/protectorasantapola/public_html/tools/smarty/plugins/modifier.date_format.php';
if (!is_callable('smarty_function_math')) include '/var/www/protectorasantapola/public_html/tools/smarty/plugins/function.math.php';
if (!is_callable('smarty_function_counter')) include '/var/www/protectorasantapola/public_html/tools/smarty/plugins/function.counter.php';
?>
...
var availableNowValue = '<?php echo preg_replace("%(?<!\\\\)'%", "\'",$_smarty_tpl->tpl_vars['product']->value->available_now);?>
';
var availableLaterValue = '<?php echo preg_replace("%(?<!\\\\)'%", "\'",$_smarty_tpl->tpl_vars['product']->value->available_later);?>
';
...
var group_reduction = '<?php echo 1-$_smarty_tpl->tpl_vars['group_reduction']->value;?>
';
...
;
var productReference = '<?php echo htmlentities($_smarty_tpl->tpl_vars['product']->value->reference, ENT_QUOTES, 'UTF-8', true);?>
';
...
')"/>
	...
	<div id="pb-right-column" class="span5">
		<!-- product img-->
		<div class="image_view_block">
			<div id="image-block">
			<?php if ($_smarty_tpl->tpl_vars['have_image']->value) {?>
				<span id="view_full_size">
					<meta property="og:image" content="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getImageLink($_smarty_tpl->tpl_vars['product']->value->link_rewrite,$_smarty_tpl->tpl_vars['cover']->value['id_image'],'pos_large'), ENT_QUOTES, 'ISO-8859-1', true);?>
"/>
					<img src="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getImageLink($_smarty_tpl->tpl_vars['product']->value->link_rewrite,$_smarty_tpl->tpl_vars['cover']->value['id_image'],'pos_large'), ENT_QUOTES, 'ISO-8859-1', true);?>
"<?php if ($_smarty_tpl->tpl_vars['jqZoomEnabled']->value&&$_smarty_tpl->tpl_vars['have_image']->value) {?> class="jqzoom"<?php }?> title="<?php echo htmlentities($_smarty_tpl->tpl_vars['product']->value->name, ENT_QUOTES, 'UTF-8', true);?>
" alt="<?php echo htmlentities($_smarty_tpl->tpl_vars['product']->value->name, ENT_QUOTES, 'UTF-8', true);?>
" id="bigpic"/>
...
-default-large_default.jpg" id="bigpic" alt="" title="<?php echo htmlentities($_smarty_tpl->tpl_vars['product']->value->name, ENT_QUOTES, 'UTF-8', true);?>
"  />
					<span class="span_link"><?php echo smartyTranslate(array('s'=>'Maximize'),$_smarty_tpl);?>
</span>
				</span>
		...
		<!-- thumbnails -->
			...
			<?php if (isset($_smarty_tpl->tpl_vars['images']->value)&&count($_smarty_tpl->tpl_vars['images']->value)>4) {?><span class="view_scroll_spacer"><a id="view_scroll_left" class="hidden thumbs" title="<?php echo smartyTranslate(array('s'=>'Other views'),$_smarty_tpl);?>
...
">
							<a href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getImageLink($_smarty_tpl->tpl_vars['product']->value->link_rewrite,$_smarty_tpl->tpl_vars['imageIds']->value,'pos_thickbox'), ENT_QUOTES, 'ISO-8859-1', true);?>
...
" src="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getImageLink($_smarty_tpl->tpl_vars['product']->value->link_rewrite,$_smarty_tpl->tpl_vars['imageIds']->value,'pos_medium'), ENT_QUOTES, 'ISO-8859-1', true);?>
...
" />
			...
			<?php if (isset($_smarty_tpl->tpl_vars['images']->value)&&count($_smarty_tpl->tpl_vars['images']->value)>4) {?><a class="thumbs" id="view_scroll_right" title="<?php echo smartyTranslate(array('s'=>'Other views'),$_smarty_tpl);?>
...
" width="11" height="13"/> <a id="resetImages" href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getProductLink($_smarty_tpl->tpl_vars['product']->value), ENT_QUOTES, 'ISO-8859-1', true);?>
...
<?php }?>
	...
	<div id="pb-left-column" class="span7">
		<h1><?php echo htmlentities($_smarty_tpl->tpl_vars['product']->value->name, ENT_QUOTES, 'UTF-8', true);?>
</h1>
...
?>
 ...
 x <a href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getProductLink($_smarty_tpl->tpl_vars['packItem']->value['id_product'],$_smarty_tpl->tpl_vars['packItem']->value['link_rewrite'],$_smarty_tpl->tpl_vars['packItem']->value['category']), ENT_QUOTES, 'ISO-8859-1', true);?>
"><?php echo htmlentities($_smarty_tpl->tpl_vars['packItem']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
</a>
		...
		<!-- add to cart form-->
		<form id="buy_block" <?php if ($_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value&&!isset($_smarty_tpl->tpl_vars['groups']->value)&&$_smarty_tpl->tpl_vars['product']->value->quantity>0) {?>class="hidden"<?php }?> action="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('cart'), ENT_QUOTES, 'ISO-8859-1', true);?>
" method="post">
...
"><?php echo htmlentities($_smarty_tpl->tpl_vars['group']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
 :&nbsp;</label>
...
"<?php if ((isset($_GET[$_smarty_tpl->tpl_vars['groupName']->value])&&intval($_GET[$_smarty_tpl->tpl_vars['groupName']->value])==$_smarty_tpl->tpl_vars['id_attribute']->value)||$_smarty_tpl->tpl_vars['group']->value['default']==$_smarty_tpl->tpl_vars['id_attribute']->value) {?> selected="selected"<?php }?> title="<?php echo htmlentities($_smarty_tpl->tpl_vars['group_attribute']->value, ENT_QUOTES, 'UTF-8', true);?>
"><?php echo htmlentities($_smarty_tpl->tpl_vars['group_attribute']->value, ENT_QUOTES, 'UTF-8', true);?>
</option>
									<?php } ?>
								</select>
...
" <?php if (($_smarty_tpl->tpl_vars['group']->value['default']==$_smarty_tpl->tpl_vars['id_attribute']->value)) {?> checked="checked"<?php }?> onclick="findCombination();getProductAttribute();" />
											<span><?php echo htmlentities($_smarty_tpl->tpl_vars['group_attribute']->value, ENT_QUOTES, 'UTF-8', true);?>
</span>
										</li>
									<?php } ?>
								</ul>
			...
			<p id="product_reference" <?php if (isset($_smarty_tpl->tpl_vars['groups']->value)||!$_smarty_tpl->tpl_vars['product']->value->reference) {?>style="display: none;"<?php }?>>
				...
				<span class="editable"><?php echo htmlentities($_smarty_tpl->tpl_vars['product']->value->reference, ENT_QUOTES, 'UTF-8', true);?>
</span>
			</p>
...
<?php }?></span> <?php echo smartyTranslate(array('s'=>'For green tax'),$_smarty_tpl);?>
 ...
 <?php echo htmlentities($_smarty_tpl->tpl_vars['product']->value->unity, ENT_QUOTES, 'UTF-8', true);?>
</p>
			<?php }?>
			...
			<div style="display:none;"><?php echo var_dump($_smarty_tpl->tpl_vars['product']->value);?>
</div>
			
			<?php if ($_smarty_tpl->tpl_vars['product']->value->id_category_default!=16&&$_smarty_tpl->tpl_vars['product']->value->id_category_default!=21&&$_smarty_tpl->tpl_vars['product']->value->id_category_default!=23) {?>
			<p class="buttons_bottom_block">
				<a href="https://protectorasantapola.org/index.php?id_cms=12&controller=cms" id="wishlist_button" title="Quiero adoptarlo" rel="nofollow">Quiero adoptar a <?php echo htmlentities($_smarty_tpl->tpl_vars['product']->value->name, ENT_QUOTES, 'UTF-8', true);?>
</a>
			</p>
		
			<p class="buttons_bottom_block">
				<a href="https://protectorasantapola.org/index.php?id_cms=12&controller=cms" id="wishlist_button" title="Tengo una casa de acogida para él" rel="nofollow">Tengo una casa de acogida para <?php echo htmlentities($_smarty_tpl->tpl_vars['product']->value->name, ENT_QUOTES, 'UTF-8', true);?>
</a>
			</p>
			<?php }?>
			...
			<p>
				<script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-51a47ea758d78062"></script>
...
?>
            <?php if (isset($_smarty_tpl->tpl_vars['feature']->value['value'])) {?>
			    <li><span><?php echo htmlentities($_smarty_tpl->tpl_vars['feature']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
</span> <?php echo htmlentities($_smarty_tpl->tpl_vars['feature']->value['value'], ENT_QUOTES, 'UTF-8', true);?>
</li>
            <?php }?>
		<?php } ?>
		</ul>
...
?>
			<li><a href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('attachment',true,null,"id_attachment=".((string)$_smarty_tpl->tpl_vars['attachment']->value['id_attachment'])), ENT_QUOTES, 'ISO-8859-1', true);?>
"><?php echo htmlentities($_smarty_tpl->tpl_vars['attachment']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
</a><br /><?php echo htmlentities($_smarty_tpl->tpl_vars['attachment']->value['description'], ENT_QUOTES, 'UTF-8', true);?>
</li>
		<?php } ?>
		</ul>
	<?php }?>
						...
						<?php if (($_smarty_tpl->tpl_vars['accessory']->value['allow_oosp']||$_smarty_tpl->tpl_vars['accessory']->value['quantity_all_versions']>0||$_smarty_tpl->tpl_vars['accessory']->value['quantity']>0)&&$_smarty_tpl->tpl_vars['accessory']->value['available_for_order']&&!isset($_smarty_tpl->tpl_vars['restricted_country_mode']->value)) {?>
							...
							<li class="ajax_block_product<?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['accessories_list']['first']) {?> first_item<?php } elseif ($_smarty_tpl->getVariable('smarty')->value['foreach']['accessories_list']['last']) {?> last_item<?php } else { ?> item<?php }?> product_accessories_description">
								<p class="s_title_block">
									<a href="<?php echo htmlentities($_smarty_tpl->tpl_vars['accessoryLink']->value, ENT_QUOTES, 'UTF-8', true);?>
"><?php echo htmlentities($_smarty_tpl->tpl_vars['accessory']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
</a>
...
<?php }?></span><?php }?>
								...
								<div class="product_desc">
									<a href="<?php echo htmlentities($_smarty_tpl->tpl_vars['accessoryLink']->value, ENT_QUOTES, 'UTF-8', true);?>
" title="<?php echo htmlentities($_smarty_tpl->tpl_vars['accessory']->value['legend'], ENT_QUOTES, 'UTF-8', true);?>
" class="product_image"><img src="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getImageLink($_smarty_tpl->tpl_vars['accessory']->value['link_rewrite'],$_smarty_tpl->tpl_vars['accessory']->value['id_image'],'pos_img_medium'), ENT_QUOTES, 'ISO-8859-1', true);?>
" alt="<?php echo htmlentities($_smarty_tpl->tpl_vars['accessory']->value['legend'], ENT_QUOTES, 'UTF-8', true);?>
" width="<?php echo $_smarty_tpl->tpl_vars['mediumSize']->value['width'];?>
" height="<?php echo $_smarty_tpl->tpl_vars['mediumSize']->value['height'];?>
" /></a>
...
" class="product_description"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['truncate'][0][0]->smarty_modifier_truncate(preg_replace('!<[^>]*?>!', ' ', $_smarty_tpl->tpl_vars['accessory']->value['description_short']),400,'...');?>
								...
								<p class="clearfix" style="margin-top:5px">
									<a class="button" href="<?php echo htmlentities($_smarty_tpl->tpl_vars['accessoryLink']->value, ENT_QUOTES, 'UTF-8', true);?>
...
<?php $_tmp1=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('cart',true,null,"qty=1&amp;id_product=".$_tmp1."&amp;token=".((string)$_smarty_tpl->tpl_vars['static_token']->value)."&amp;add"), ENT_QUOTES, 'ISO-8859-1', true);?>
...
_small" alt="" />
										<a href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getProductDeletePictureLink($_smarty_tpl->tpl_vars['product']->value,$_smarty_tpl->tpl_vars['field']->value['id_customization_field']), ENT_QUOTES, 'ISO-8859-1', true);?>
...
<?php }?>
<?php }?>
<?php if (isset($_smarty_tpl->tpl_vars['HOOK_PRODUCT_FOOTER']->value)&&$_smarty_tpl->tpl_vars['HOOK_PRODUCT_FOOTER']->value&&$_smarty_tpl->tpl_vars['product']->value->id_category_default!=16&&$_smarty_tpl->tpl_vars['product']->value->id_category_default!=21&&$_smarty_tpl->tpl_vars['product']->value->id_category_default!=23) {?><?php echo $_smarty_tpl->tpl_vars['HOOK_PRODUCT_FOOTER']->value;?>
 <?php }?>
<?php }} ?>
