<?php /* Smarty version Smarty-3.1.19, created on 2019-05-03 21:26:57
         compiled from "/var/www/protectorasantapola/themes/pos_petsyshop/product.tpl" */ ?>
<?php /*%%SmartyHeaderCode:622600715ccc9601dff933-89577934%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f8238741e6cdc72d9ca04cb19281e7162e5883d1' => 
    array (
      0 => '/var/www/protectorasantapola/themes/pos_petsyshop/product.tpl',
      1 => 1552330326,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '622600715ccc9601dff933-89577934',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ccc96025ea9b1_83124258',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ccc96025ea9b1_83124258')) {function content_5ccc96025ea9b1_83124258($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/var/www/protectorasantapola/tools/smarty/plugins/modifier.date_format.php';
if (!is_callable('smarty_function_math')) include '/var/www/protectorasantapola/tools/smarty/plugins/function.math.php';
if (!is_callable('smarty_function_counter')) include '/var/www/protectorasantapola/tools/smarty/plugins/function.counter.php';
?>
...
;
var productReference = '<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['product']->value->reference, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
';
		...
		<div class="image_view_block">
			...
			<?php if ($_smarty_tpl->tpl_vars['have_image']->value) {?>
				<span id="view_full_size">
					<meta property="og:image" content="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getImageLink($_smarty_tpl->tpl_vars['product']->value->link_rewrite,$_smarty_tpl->tpl_vars['cover']->value['id_image'],'pos_large'), ENT_QUOTES, 'UTF-8', true);?>
"/>
					<img src="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getImageLink($_smarty_tpl->tpl_vars['product']->value->link_rewrite,$_smarty_tpl->tpl_vars['cover']->value['id_image'],'pos_large'), ENT_QUOTES, 'UTF-8', true);?>
"<?php if ($_smarty_tpl->tpl_vars['jqZoomEnabled']->value&&$_smarty_tpl->tpl_vars['have_image']->value) {?> class="jqzoom"<?php }?> title="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['product']->value->name, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
...
-default-large_default.jpg" id="bigpic" alt="" title="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['product']->value->name, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
"  />
					<span class="span_link"><?php echo smartyTranslate(array('s'=>'Maximize'),$_smarty_tpl);?>
</span>
				</span>
...
">
							<a href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getImageLink($_smarty_tpl->tpl_vars['product']->value->link_rewrite,$_smarty_tpl->tpl_vars['imageIds']->value,'pos_thickbox'), ENT_QUOTES, 'UTF-8', true);?>
...
" src="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getImageLink($_smarty_tpl->tpl_vars['product']->value->link_rewrite,$_smarty_tpl->tpl_vars['imageIds']->value,'pos_medium'), ENT_QUOTES, 'UTF-8', true);?>
...
<?php }?>
	...
	<div id="pb-left-column" class="span7">
		<h1><?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['product']->value->name, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
</h1>
...
<?php }?></span> <?php echo smartyTranslate(array('s'=>'For green tax'),$_smarty_tpl);?>
 ...
 <?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['product']->value->unity, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
			...
			<p class="buttons_bottom_block">
				<a href="https://protectorasantapola.org/index.php?id_cms=12&controller=cms" id="wishlist_button" title="Quiero adoptarlo" rel="nofollow">Quiero adoptar a <?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['product']->value->name, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
</a>
			</p>
		
			<p class="buttons_bottom_block">
				<a href="https://protectorasantapola.org/index.php?id_cms=12&controller=cms" id="wishlist_button" title="Tengo una casa de acogida para él" rel="nofollow">Tengo una casa de acogida para <?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['product']->value->name, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
</a>
			</p>
			<?php }?>
...
<?php }?></span><?php }?>
								...
								<div class="product_desc">
									<a href="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['accessoryLink']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
" title="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['accessory']->value['legend'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
" class="product_image"><img src="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getImageLink($_smarty_tpl->tpl_vars['accessory']->value['link_rewrite'],$_smarty_tpl->tpl_vars['accessory']->value['id_image'],'pos_img_medium'), ENT_QUOTES, 'UTF-8', true);?>
...
" class="product_description"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['truncate'][0][0]->smarty_modifier_truncate(preg_replace('!<[^>]*?>!', ' ', $_smarty_tpl->tpl_vars['accessory']->value['description_short']),400,'...');?>
								...
								<p class="clearfix" style="margin-top:5px">
									<a class="button" href="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['accessoryLink']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
