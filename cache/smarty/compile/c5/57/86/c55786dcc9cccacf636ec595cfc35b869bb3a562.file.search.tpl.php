<?php /* Smarty version Smarty-3.1.19, created on 2020-09-07 10:07:18
         compiled from "/var/www/protectorasantapola/public_html/themes/pos_petsyshop/search.tpl" */ ?>
<?php /*%%SmartyHeaderCode:4141956485f55ea3603f409-57876432%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c55786dcc9cccacf636ec595cfc35b869bb3a562' => 
    array (
      0 => '/var/www/protectorasantapola/public_html/themes/pos_petsyshop/search.tpl',
      1 => 1556915561,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '4141956485f55ea3603f409-57876432',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5f55ea360a8795_96396586',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f55ea360a8795_96396586')) {function content_5f55ea360a8795_96396586($_smarty_tpl) {?>
...
&nbsp;<?php if ($_smarty_tpl->tpl_vars['nbProducts']->value>0) {?>"<?php if (isset($_smarty_tpl->tpl_vars['search_query']->value)&&$_smarty_tpl->tpl_vars['search_query']->value) {?><?php echo htmlentities($_smarty_tpl->tpl_vars['search_query']->value, ENT_QUOTES, 'UTF-8', true);?>
<?php } elseif ($_smarty_tpl->tpl_vars['search_tag']->value) {?><?php echo htmlentities($_smarty_tpl->tpl_vars['search_tag']->value, ENT_QUOTES, 'UTF-8', true);?>
<?php } elseif ($_smarty_tpl->tpl_vars['ref']->value) {?><?php echo htmlentities($_smarty_tpl->tpl_vars['ref']->value, ENT_QUOTES, 'UTF-8', true);?>
<?php }?>"<?php }?>
...
&nbsp;"<?php if (isset($_smarty_tpl->tpl_vars['search_query']->value)) {?><?php echo htmlentities($_smarty_tpl->tpl_vars['search_query']->value, ENT_QUOTES, 'UTF-8', true);?>
<?php }?>"
		<?php } elseif (isset($_smarty_tpl->tpl_vars['search_tag']->value)&&$_smarty_tpl->tpl_vars['search_tag']->value) {?>
			<?php echo smartyTranslate(array('s'=>'No results were found for your search'),$_smarty_tpl);?>
&nbsp;"<?php echo htmlentities($_smarty_tpl->tpl_vars['search_tag']->value, ENT_QUOTES, 'UTF-8', true);?>
"
		<?php } else { ?>
