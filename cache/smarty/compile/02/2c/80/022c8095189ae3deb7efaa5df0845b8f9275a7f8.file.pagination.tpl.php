<?php /* Smarty version Smarty-3.1.19, created on 2020-09-10 10:25:26
         compiled from "/var/www/protectorasantapola/public_html/themes/pos_petsyshop/pagination.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2492925165f59e2f661b1b1-12409419%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '022c8095189ae3deb7efaa5df0845b8f9275a7f8' => 
    array (
      0 => '/var/www/protectorasantapola/public_html/themes/pos_petsyshop/pagination.tpl',
      1 => 1556915561,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2492925165f59e2f661b1b1-12409419',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5f59e2f66f31f8_83382956',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f59e2f66f31f8_83382956')) {function content_5f59e2f66f31f8_83382956($_smarty_tpl) {?>
...
<?php }?>" class="pagination">
		<span class="pagination-title">Página </span>
...
?>
			<?php if ($_smarty_tpl->tpl_vars['p']->value==$_smarty_tpl->getVariable('smarty')->value['section']['pagination']['index']) {?>
				<li class="current"><span><?php echo htmlentities($_smarty_tpl->tpl_vars['p']->value, ENT_QUOTES, 'UTF-8', true);?>
</span></li>
			<?php } else { ?>
				<li><a <?php echo $_smarty_tpl->tpl_vars['no_follow_text']->value;?>
...
"><?php echo htmlentities($_smarty_tpl->getVariable('smarty')->value['section']['pagination']['index'], ENT_QUOTES, 'UTF-8', true);?>
</a></li>
			<?php }?>
		<?php endfor; endif; ?>
...
&nbsp;&raquo;</span></li>
		...
		<?php } else { ?><span class="pagination-title">1</span>
	<?php }?>
