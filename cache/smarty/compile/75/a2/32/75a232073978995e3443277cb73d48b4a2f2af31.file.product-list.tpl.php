<?php /* Smarty version Smarty-3.1.19, created on 2021-01-20 11:54:04
         compiled from "/var/www/protectorasantapola/public_html/themes/pos_petsyshop/product-list.tpl" */ ?>
<?php /*%%SmartyHeaderCode:121714940660080bcc861e18-30442879%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '75a232073978995e3443277cb73d48b4a2f2af31' => 
    array (
      0 => '/var/www/protectorasantapola/public_html/themes/pos_petsyshop/product-list.tpl',
      1 => 1556915561,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '121714940660080bcc861e18-30442879',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_60080bccbb8af5_98137048',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_60080bccbb8af5_98137048')) {function content_60080bccbb8af5_98137048($_smarty_tpl) {?>
...
<?php $_tmp2=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('cart',false,null,"add=1&amp;id_product=".$_tmp2."&amp;token=".((string)$_smarty_tpl->tpl_vars['static_token']->value),false), ENT_QUOTES, 'ISO-8859-1', true);?>
...
">
						...
						<?php } else { ?>
							<a class="button ajax_add_to_cart_button exclusive" rel="ajax_id_product_<?php echo intval($_smarty_tpl->tpl_vars['product']->value['id_product']);?>
" href="<?php ob_start();?><?php echo intval($_smarty_tpl->tpl_vars['product']->value['id_product']);?>
<?php $_tmp3=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('cart',false,null,"add=1&amp;id_product=".$_tmp3,false), ENT_QUOTES, 'ISO-8859-1', true);?>
" title="<?php echo smartyTranslate(array('s'=>'Add to cart'),$_smarty_tpl);?>
...
, 1); return false;"><?php echo smartyTranslate(array('s'=>'Add To Wishlist'),$_smarty_tpl);?>
					...
					<?php }?>
				<?php }?>
				<!--<a class="button lnk_view" href="<?php echo htmlentities($_smarty_tpl->tpl_vars['product']->value['link'], ENT_QUOTES, 'UTF-8', true);?>
