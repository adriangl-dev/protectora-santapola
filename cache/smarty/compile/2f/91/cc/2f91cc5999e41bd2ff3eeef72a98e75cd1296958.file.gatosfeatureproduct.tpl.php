<?php /* Smarty version Smarty-3.1.19, created on 2021-01-20 11:54:04
         compiled from "/var/www/protectorasantapola/public_html/modules/gatosfeatureproduct/gatosfeatureproduct.tpl" */ ?>
<?php /*%%SmartyHeaderCode:95591773760080bcc1a4326-11479422%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2f91cc5999e41bd2ff3eeef72a98e75cd1296958' => 
    array (
      0 => '/var/www/protectorasantapola/public_html/modules/gatosfeatureproduct/gatosfeatureproduct.tpl',
      1 => 1556915561,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '95591773760080bcc1a4326-11479422',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_60080bcc282d65_97867693',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_60080bcc282d65_97867693')) {function content_60080bcc282d65_97867693($_smarty_tpl) {?><!-- Begin Gatosfeatureproduct module-->
<!-- Display Gatos en adopción in homepage-->
...
" class="product_image"><img src="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getImageLink($_smarty_tpl->tpl_vars['product']->value['link_rewrite'],$_smarty_tpl->tpl_vars['product']->value['id_image'],'pos_product'), ENT_QUOTES, 'ISO-8859-1', true);?>
...
<a style="color:#0093dd;" href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value['link'], ENT_QUOTES, 'ISO-8859-1', true);?>
">Ver más</a></div>
...
"><?php echo smartyTranslate(array('s'=>'Add to cart','mod'=>'posfeatureproduct'),$_smarty_tpl);?>
	...
	<a href="https://protectorasantapola.org/index.php?id_category=14&controller=category">
		<div class="pos-feature-product-title span3">
			<div class="pos-feature-product-title-inner">
				<p class="title"><?php echo smartyTranslate(array('s'=>'Ver más gatos en adopción','mod'=>'posfeatureproduct'),$_smarty_tpl);?>
</p>
				<p><?php echo smartyTranslate(array('s'=>' Haz click aquí para ver más gatos que están deseando conocerte','mod'=>'posfeatureproduct'),$_smarty_tpl);?>
</p>
...
<!--End Gatosfeatureproduct module-->
<?php }} ?>
