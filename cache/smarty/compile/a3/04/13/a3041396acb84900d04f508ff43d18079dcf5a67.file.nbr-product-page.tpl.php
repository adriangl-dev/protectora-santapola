<?php /* Smarty version Smarty-3.1.19, created on 2020-09-10 10:25:26
         compiled from "/var/www/protectorasantapola/public_html/themes/pos_petsyshop/nbr-product-page.tpl" */ ?>
<?php /*%%SmartyHeaderCode:7117455125f59e2f66fabf8-42906249%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a3041396acb84900d04f508ff43d18079dcf5a67' => 
    array (
      0 => '/var/www/protectorasantapola/public_html/themes/pos_petsyshop/nbr-product-page.tpl',
      1 => 1556915561,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '7117455125f59e2f66fabf8-42906249',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5f59e2f677edf8_12002673',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f59e2f677edf8_12002673')) {function content_5f59e2f677edf8_12002673($_smarty_tpl) {?>
...
<?php }?>" method="get" class="nbrItemPage pagination">
			<p>
				<?php if (isset($_smarty_tpl->tpl_vars['search_query']->value)&&$_smarty_tpl->tpl_vars['search_query']->value) {?><input type="hidden" name="search_query" value="<?php echo htmlentities($_smarty_tpl->tpl_vars['search_query']->value, ENT_QUOTES, 'UTF-8', true);?>
" /><?php }?>
				<?php if (isset($_smarty_tpl->tpl_vars['tag']->value)&&$_smarty_tpl->tpl_vars['tag']->value&&!is_array($_smarty_tpl->tpl_vars['tag']->value)) {?><input type="hidden" name="tag" value="<?php echo htmlentities($_smarty_tpl->tpl_vars['tag']->value, ENT_QUOTES, 'UTF-8', true);?>
" /><?php }?>
...
?>
						<?php if ($_smarty_tpl->tpl_vars['requestKey']->value!='requestUrl') {?>
							<input type="hidden" name="<?php echo htmlentities($_smarty_tpl->tpl_vars['requestKey']->value, ENT_QUOTES, 'UTF-8', true);?>
" value="<?php echo htmlentities($_smarty_tpl->tpl_vars['requestValue']->value, ENT_QUOTES, 'UTF-8', true);?>
" />
						<?php }?>
					<?php } ?>
				<?php }?>
...
?>
					<?php if ($_smarty_tpl->tpl_vars['lastnValue']->value<=$_smarty_tpl->tpl_vars['nb_products']->value) {?>
						<option value="<?php echo htmlentities($_smarty_tpl->tpl_vars['nValue']->value, ENT_QUOTES, 'UTF-8', true);?>
" <?php if ($_smarty_tpl->tpl_vars['n']->value==$_smarty_tpl->tpl_vars['nValue']->value) {?>selected="selected"<?php }?>><?php echo htmlentities($_smarty_tpl->tpl_vars['nValue']->value, ENT_QUOTES, 'UTF-8', true);?>
</option>
					<?php }?>
